...
const HeroSection = () => {
  return (
    <section className="overflow-hidden HeroSection">
      <div className="container">
        <div className="content">
          <div className="flex flex-col gap-5 text-center lg:text-left">
            <h1 className="hidden text-6xl font-semibold lg:inline">
              Linear is a purpose-built tool for planning and building products
            </h1>
            <h1 className="text-6xl font-semibold lg:hidden">
              Plan and build your product
            </h1>
            <div className="flex flex-col items-center lg:flex-row">
              <h2 className="max-w-[500px] text-[rgba(255,255,255,0.7)] text-[21px] text-xl font-medium hidden lg:inline ">
                Meet the system for modern software development. Streamline
                issues, projects, and product roadmaps.
              </h2>
              <h2 className="max-w-[500px] text-[rgba(255,255,255,0.7)] text-[21px] text-xl font-medium lg:hidden">
            ...
            <div className="flex flex-col items-center gap-8 lg:flex-row">
              <a
                href=""
                type="button"
                className="bg-[#e6e6e6] text-[#08090a] px-[20px] py-[10px] rounded-[12px] shadow-[0px 8px 2px 0px transparent, 0px 5px 2px 0px rgba(0, 0, 0, .01), 0px 3px 2px 0px rgba(0, 0, 0, .04), 0px 1px 1px 0px rgba(0, 0, 0, .07), 0px 0px 1px 0px rgba(0, 0, 0, .08);] "
              >
                Start Building
              </a>
        ...
        <div className="relative pt-[72px]">
          <div className="w-full pl-[max(env(safe-area-inset-left),24px)] pr-[max(env(safe-area-inset-right),24px)] max-w-[1024px]">
            <div className="relative select-none w-[100vw] left-[50%] right-[50%] ml-[-50vw] mr-[-50vw] after:content-[''] before:content-[''] before:block before:bg-[red] before:mt-[-140px] after:absolute after:inset-[0] after:z-[2] after:bg-gradient-to-b after:from-transparent after:from-50% after:to-[#08090a] after:to-100%">
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      transform:
                        "translateX(2%) scale(1.2) rotateX(47deg) rotateY(31deg) rotateZ(324deg)",
                      transformOrigin: "top left",
                      transformStyle: "preserve-3d",
                      backfaceVisibility: "hidden",
                    }}
                  >
                    <div className="w-[260px] p-[16px_14px]">
                      <div className="">
                        <div className="flex flex-col gap-2">
                          <div className="flex items-center justify-between">
                            <div className="flex gap-2">
                              <div className="bg-[#262626] rounded-[50%] w-3 h-3"></div>
                              <div className="bg-[#262626] rounded-[50%] w-3 h-3"></div>
                              <div className="bg-[#262626] rounded-[50%] w-3 h-3"></div>
                            </div>
                            <div className="">
                              ...
                              >
                                <path
                                  d="M9.67382 15.4801C9.93899 15.7983 10.4119 15.8413 10.7301 15.5761C11.0483 15.311 11.0913 14.8381 10.8261 14.5198L9.35128 12.75L16.25 12.75C16.6642 12.75 17 12.4142 17 12C17 11.5858 16.6642 11.25 16.25 11.25L9.35125 11.25L10.8261 9.48012C11.0913 9.16191 11.0483 8.68899 10.7301 8.42381C10.4119 8.15864 9.93899 8.20163 9.67382 8.51984L7.17382 11.5198C6.94204 11.798 6.94204 12.202 7.17382 12.4801L9.67382 15.4801Z"
                                  fill="#949698"
                                ></path>
                                <g opacity="0.6">
                                  <path
                                    d="M38.3262 8.51988C38.061 8.20167 37.5881 8.15868 37.2699 8.42385C36.9517 8.68903 36.9087 9.16195 37.1739 9.48016L38.6487 11.25H31.75C31.3358 11.25 31 11.5858 31 12C31 12.4142 31.3358 12.75 31.75 12.75H38.6488L37.1739 14.5199C36.9087 14.8381 36.9517 15.311 37.2699 15.5762C37.5881 15.8414 38.061 15.7984 38.3262 15.4802L40.8262 12.4802C41.058 12.202 41.058 11.798 40.8262 11.5199L38.3262 8.51988Z"
                                    fill="#949698"
                                  ></path>
                                </g>
                                <path
                                  d="M72.75 9C72.75 8.58579 72.4142 8.25 72 8.25C71.5858 8.25 71.25 8.58579 71.25 9V12C71.25 12.4142 71.5858 12.75 72 12.75H75C75.4142 12.75 75.75 12.4142 75.75 12C75.75 11.5858 75.4142 11.25 75 11.25H72.75V9Z"
                                  fill="#949698"
                                ></path>
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M79 12C79 15.866 75.866 19 72 19C68.134 19 65 15.866 65 12C65 8.13401 68.134 5 72 5C75.866 5 79 8.13401 79 12ZM77.5 12C77.5 15.0376 75.0376 17.5 72 17.5C68.9624 17.5 66.5 15.0376 66.5 12C66.5 8.96243 68.9624 6.5 72 6.5C75.0376 6.5 77.5 8.96243 77.5 12Z"
                                  fill="#949698"
                                ></path>
                              </svg>
                            </div>
                          ...
                          <div className="flex items-center justify-between header">
                            <div
                              className="HeroIllustration_3d__JMg8B HeroIllustration_animateIn__D6wW2"
                              style={{
                                opacity: "1",
                                filter: "blur(0px)",
                            ...
                            >
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <g clip-path="url(#clip0_7597_40642)">
                                  <rect
                                    width="20"
                                    height="20"
                                    fill="#0E1010"
                            ...
                            >
                              <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                              >
                                <g filter="url(#filter0_dd_6793_8685)">
                                  <rect
                                    x="34"
                                    y="2"
                                    width="28"
                                ...
                                <defs>
                                  ...
                                  >
                                    ...
                                    <feBlend
                                      ...
                                      result="effect1_dropShadow_6793_8685"
                                    ></feBlend>
                                    <feColorMatrix
                                      in="SourceAlpha"
                                      type="matrix"
                                    ...
                                    <feBlend
                                      mode="normal"
                                      in2="effect1_dropShadow_6793_8685"
                                    ...
                                    <feBlend
                                      mode="normal"
                                      in="SourceGraphic"
                                      in2="effect2_dropShadow_6793_8685"
                                      result="shape"
                                    ></feBlend>
                                  </filter>
                                  <clipPath id="clip0_6793_8685">
                                    <rect
                                      width="16"
                                      height="16"
                                      fill="white"
                              ...
                              >
                                ...
                                <defs>
                                  ...
                                  >
                                    ...
                                    <feBlend
                                      in2="BackgroundImageFix"
                                      result="effect1_dropShadow_7597_40572"
                                    ></feBlend>
                                    <feBlend
                                      in="SourceGraphic"
                                      in2="effect1_dropShadow_7597_40572"
                                      result="shape"
                                    ></feBlend>
                                  </filter>
                                </defs>
                            ...
                            >
                              ...
                              >
                                ...
                                <path
                                  fill="#949698"
                                  fill-rule="evenodd"
                                  d="M15 62a1 1 0 0 1-.5.866v.634a.5.5 0 0 0 .5.5h.5c1.398 0 2.097 0 2.648.228a3 3 0 0 1 1.624 1.624c.228.551.228 1.25.228 2.648 0 1.398 0 2.097-.228 2.648a3 3 0 0 1-1.624 1.624c-.434.18-.96.218-1.849.226a.301.301 0 0 0-.299.3v.402a.3.3 0 0 0 .3.3h.2a.5.5 0 0 1 .5.5v.3a.2.2 0 0 1-.2.2h-5.6a.2.2 0 0 1-.2-.2v-.3a.5.5 0 0 1 .5-.5h.2a.3.3 0 0 0 .3-.3v-.401c0-.166-.134-.3-.3-.301-.887-.008-1.413-.046-1.848-.226a3 3 0 0 1-1.624-1.624C8 70.597 8 69.898 8 68.5c0-1.398 0-2.097.228-2.648a3 3 0 0 1 1.624-1.624C10.403 64 11.102 64 12.5 64h.5a.5.5 0 0 0 .5-.5v-.634A1 1 0 1 1 15 62Zm-4 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm7-1a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-5.6 2a.4.4 0 0 0-.4.4v.7c0 .22.18.4.4.4h3.2a.4.4 0 0 0 .4-.4v-.7a.4.4 0 0 0-.4-.4h-3.2Z"
                                  clip-rule="evenodd"
                                ></path>
                                <path
                                  fill="#E2E4E6"
                                ...
                                <path
                                  fill="#595B5D"
                                  d="M109.002 71.624a.5.5 0 0 1-.752-.432v-4.384a.5.5 0 0 1 .752-.432l3.758 2.192a.5.5 0 0 1 0 .864l-3.758 2.192Z"
                                ></path>
                              </svg>
                            </div>
                          </div>
